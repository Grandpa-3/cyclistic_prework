-- Query to capture a table with data from the entire year and join tables
SELECT
  TRI.usertype,
  ...
  -- Since this is a fictional dashboard, 5 years added to make it look recent
...
INNER JOIN
  ...
  `singular-arbor-428308-p5.cyclistics.zip_codes` AS ZIPSTARTNAME
  ON ZIPSTART.zip_code = CAST(ZIPSTARTNAME.zip AS STRING)
INNER JOIN
  -- Note! Add your zipcode table name, enclosed in backticks: `example_table`
  `singular-arbor-428308-p5.cyclistics.zip_codes` AS ZIPENDNAME
